...
export interface components {
    schemas: {
        ...
        PoolAssignmentReopenedPayload: {
            /** @description ID of the pool-routed work bead reopened back to the pool. */
            bead_id: string;
            /** @description Assignee the bead carried before reopen — the stale (dead-session) claimant. Empty when recovering an unassigned in-progress bead. */
            prev_assignee?: string;
            /** @description Short diagnostic context. Today the single emission site passes 'orphaned_pool_assignment'. */
            reason?: string;
            /** @description Pool route (gc.routed_to) the bead re-enters for re-claiming. */
            template?: string;
        };
        PoolOverride: {
            Check: string | null;
        ...
        TypedEventStreamEnvelopePoolAssignmentReopened: {
            actor: string;
            message?: string;
            payload: components["schemas"]["PoolAssignmentReopenedPayload"];
            /** Format: int64 */
            seq: number;
            subject?: string;
            /** Format: date-time */
